<?php
	...
	function get_product($con,$limit='',$cat_id='', $product_id='',$search_str='',$sort_order='',$is_best_seller=''){
		...
		if ($search_str!='') {
			$sql.=" and (product.name like '%$search_str%' or product.description like '%$search_str%' or product.meta_keyword like '%$search_str%' or product.name like '$search_str%' or product.description like '$search_str%' or product.meta_keyword like '$search_str%' or product.name like '%$search_str' or product.description like '%$search_str' or product.meta_keyword like '%$search_str' or product.name like '_$search_str%' or product.description like '_$search_str%' or product.meta_keyword like '_$search_str%' or product.name like '$search_str _%' or product.description like '$search_str _%' or product.meta_keyword like '$search_str _%' or product.name like '$search_str __%' or product.description like '$search_str __%' or product.meta_keyword like '$search_str __%')";
		}
		if ($sort_order!='') {
			$sql.=$sort_order;
		}else{
	...
	function productSoldQtyByProductId($con,$pid){
		$sql="select sum(order_detail.qty) as qty from order_detail,`order` where `order`.id=order_detail.order_id and order_detail.product_id=$pid and `order`.order_status!=4 and ((`order`.payment_type='pay_online' and `order`.payment_status='Success') or (`order`.payment_type='cash_on_delivery' and `order`.payment_status!=''))";
		$res=mysqli_query($con,$sql);
	...
	function setnInvoice($con,$order_id){
		          ...
		          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
		            <tr>
		              <td class="email-masthead">
		                ...
		                <img style="height:30px; width:auto;" class="disabledownload" src="images/logo.png">
		              </a>
		              </td>
		            </tr>
		            <!-- Email Body -->
		            <tr>
		                  ...
		                  <tr>
		                    <td class="content-cell">
		                      <div class="f-fallback">
		                        ...
		                        <p>Thanks for using <b>pickups</b>.<br>
		                        This is an invoice for your recent purchase.</p>
		              ...
		              <strong>Amount :</strong> '.$user_order['total_price'].'
		                        ...
		                        <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
		                          <tr>
		                            <td>
		                              <h3>'.$user_order['order_place_id'].'</h3>
		                            </td>
		                            <td>
		                ...
		                <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
		                  <tr>
		                    <td class="content-cell" align="center">
		                      <p class="f-fallback sub align-center">&copy; 2021 pickups. All rights reserved.</p>
		...
		if ($mail->send()) {
			//echo "Please check your mail box for password";
		}else{
